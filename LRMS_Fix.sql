...
VALUES 
('user1', '$2a$11$ioVSpEVBZDeUgJLi0399K.g7O5CYHzablfqJESjL7FW0SJuGrbyWC', 'Nguyễn Văn A', 'lecturer1@example.com', '0123456789', 1, 1, 1, GETDATE(), GETDATE(), 1, 0),
('user2', '$2a$11$ioVSpEVBZDeUgJLi0399K.g7O5CYHzablfqJESjL7FW0SJuGrbyWC', 'Trần Thị B', 'student1@example.com', '0123456788', 2, 1, 1, GETDATE(), GETDATE(), 1, 1),
('user3', '$2a$11$ioVSpEVBZDeUgJLi0399K.g7O5CYHzablfqJESjL7FW0SJuGrbyWC', 'Lê Văn C', 'lecturer2@example.com', '0123456787', 1, 2, 1, GETDATE(), GETDATE(), 2, 2),
('user4', '$2a$11$ioVSpEVBZDeUgJLi0399K.g7O5CYHzablfqJESjL7FW0SJuGrbyWC', 'Phạm Thị D', 'office1@example.com', '0123456786', 4, 2, 1, GETDATE(), GETDATE(), 2, 3),
('user5', '$2a$11$ioVSpEVBZDeUgJLi0399K.g7O5CYHzablfqJESjL7FW0SJuGrbyWC', 'Nguyễn Văn E', 'accountingDep1@example.com', '0123456785', 3, 1, 1, GETDATE(), GETDATE(), 1, 4),
('user6', '$2a$11$ioVSpEVBZDeUgJLi0399K.g7O5CYHzablfqJESjL7FW0SJuGrbyWC', 'Trần Thị F', 'accountingDep2@example.com', '0123456784', 3, 1, 1, GETDATE(), GETDATE(), 1, 2);
