...
-- Ngắt tất cả các kết nối đến LRMSDB trước khi xóa
IF EXISTS (SELECT name FROM sys.databases WHERE name = 'LRMSDB')
BEGIN
    ALTER DATABASE LRMSDB
...
CREATE TABLE [Timeline] (
    ...
    CONSTRAINT FK_Timeline_TimelineSequence FOREIGN KEY([sequence_id]) REFERENCES [TimelineSequence]([sequence_id]),
    CONSTRAINT FK_Timeline_Users FOREIGN KEY([created_by]) REFERENCES [Users]([user_id])
);
GO

-- Tạo bảng Invitations
...
-- 4. Dữ liệu cho bảng Group_Member
...
-- 5. Dữ liệu cho bảng TimelineSequence (Chèn trước vì Projects tham chiếu đến nó)
...
('Fund Disbursement Cycle', 'Timeline for fund disbursement processes', '#33FF57', GETDATE(), GETDATE(), 2),
('Conference Paper Cycle 2025', 'Timeline for conference paper submissions', '#3357FF', GETDATE(), GETDATE(), 3);
GO

-- 6. Dữ liệu cho bảng Projects (Chèn sau TimelineSequence vì có khóa ngoại sequence_id)
INSERT INTO [Projects] ([project_name], [project_type], [description], [approved_budget], [spent_budget], [status], [start_date], [end_date], 
[created_at], [updated_at], [methodlogy], [approved_by], [created_by], [group_id], [department_id], [sequence_id])
VALUES 
(N'Project 1', 1, N'Mô tả dự án 1', 10000.00, 5000.00, 1, GETDATE(), DATEADD(MONTH, 1, GETDATE()), GETDATE(), GETDATE(), N'Phương pháp 1', 1, 1, 1, 1, 1),
(N'Project 2', 1, N'Mô tả dự án 2', 20000.00, 10000.00, 1, GETDATE(), DATEADD(MONTH, 2, GETDATE()), GETDATE(), GETDATE(), N'Phương pháp 2', 2, 2, 1, 1, 1),
(N'Project 3', 2, N'Mô tả dự án 3', 15000.00, 7000.00, 1, GETDATE(), DATEADD(MONTH, 3, GETDATE()), GETDATE(), GETDATE(), N'Phương pháp 3', 3, 3, 2, 2, 2),
(N'Project 4', 2, N'Mô tả dự án 4', 25000.00, 12000.00, 1, GETDATE(), DATEADD(MONTH, 4, GETDATE()), GETDATE(), GETDATE(), N'Phương pháp 4', 4, 4, 2, 2, 2),
(N'Project 5', 1, N'Mô tả dự án 5', 30000.00, 15000.00, 1, GETDATE(), DATEADD(MONTH, 5, GETDATE()), GETDATE(), GETDATE(), N'Phương pháp 5', 5, 5, 1, 1, 3),
(N'Project 6', 1, N'Mô tả dự án 6', 18000.00, 9000.00, 1, GETDATE(), DATEADD(MONTH, 6, GETDATE()), GETDATE(), GETDATE(), N'Phương pháp 6', 6, 6, 1, 1, 3);
GO

-- 7. Dữ liệu cho bảng Quotas (Chèn sau Projects vì có khóa ngoại project_id)
...
-- 8. Dữ liệu cho bảng Milestone (Chèn sau Projects vì có khóa ngoại project_id)
...
-- 9. Dữ liệu cho bảng Project_resources (Chèn sau Projects vì có khóa ngoại project_id)
...
-- 10. Dữ liệu cho bảng Conference (Chèn sau Projects vì có khóa ngoại project_id)
...
-- 11. Dữ liệu cho bảng Conference_expense (Chèn sau Conference vì có khóa ngoại conference_id)
...
-- 12. Dữ liệu cho bảng Journal (Chèn sau Projects vì có khóa ngoại project_id)
...
-- 13. Dữ liệu cho bảng Author (Chèn sau Projects vì có khóa ngoại project_id)
...
-- 14. Dữ liệu cho bảng Category (Chèn sau Projects vì có khóa ngoại project_id)
...
-- 15. Dữ liệu cho bảng Timeline (Chèn sau TimelineSequence vì có khóa ngoại sequence_id)
...
(2, '2025-07-01', '2025-07-15', 'Fund Request Period', GETDATE(), GETDATE(), 1, 2),
(2, '2025-07-16', '2025-07-31', 'Fund Approval Period', GETDATE(), GETDATE(), 2, 2),
(3, '2025-08-01', '2025-08-15', 'Conference Paper Submissions', GETDATE(), GETDATE(), 1, 3),
(3, '2025-08-16', '2025-08-31', 'Paper Review Period', GETDATE(), GETDATE(), 2, 3);
GO

-- 16. Dữ liệu cho bảng Invitations
...
-- 17. Dữ liệu cho bảng Notifications (Chèn sau Projects và Invitations vì có khóa ngoại project_id và invitation_id)
...
-- 18. Dữ liệu cho bảng Documents (Chèn sau Projects, Milestone, Project_resources, Conference_expense vì có khóa ngoại)
...
-- 19. Dữ liệu cho bảng Fund_Disbursement (Chèn sau Projects và Author vì có khóa ngoại project_id và author_request)
...
-- 20. Thêm các cột vào bảng Users (phần code ở dòng 19 trong script gốc)
