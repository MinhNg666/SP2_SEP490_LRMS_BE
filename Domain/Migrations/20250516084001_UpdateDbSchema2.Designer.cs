...
namespace Domain.Migrations
{
    ...
    [Migration("20250516084001_UpdateDbSchema2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LRMS_API.AssignReview", b =>
                {
                    ...
                    b.ToTable("AssignReview", (string)null);
                });
            ...
            modelBuilder.Entity("LRMS_API.AuthorConference", b =>
                {
                    b.Property<int>("AuthorConferenceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("author_conference_id");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AuthorConferenceId"));
                    ...
                    b.HasKey("AuthorConferenceId");

                    b.HasIndex("AuthorId");

                    b.HasIndex("ConferenceId");

                    b.ToTable("AuthorConference", (string)null);
                });

            modelBuilder.Entity("LRMS_API.AuthorJournal", b =>
                {
                    b.Property<int>("AuthorJournalId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("author_journal_id");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AuthorJournalId"));
                    ...
                    b.HasKey("AuthorJournalId");

                    b.HasIndex("AuthorId");

                    b.HasIndex("JournalId");

                    b.ToTable("AuthorJournal", (string)null);
                });
            ...
            modelBuilder.Entity("LRMS_API.CouncilVote", b =>
                {
                    ...
                    b.ToTable("CouncilVote", (string)null);
                });
            ...
            modelBuilder.Entity("LRMS_API.Expertise", b =>
                {
                    ...
                    b.Property<int?>("ExpertiseStatus")
                        .HasColumnType("int")
                        .HasColumnName("expertise_status");
            ...
            modelBuilder.Entity("LRMS_API.Inspection", b =>
                {
                    b.Property<int>("InspectionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LRMS_API.ProgressReport", b =>
                {
                    b.Property<int>("ProgressReportId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LRMS_API.VoteResult", b =>
                {
                    ...
                    b.ToTable("VoteResult", (string)null);
                });

            modelBuilder.Entity("LRMS_API.AssignReview", b =>
                {
                    b.HasOne("LRMS_API.User", "AssignedByUser")
                        .WithMany("AssignReviewsMade")
            ...
            modelBuilder.Entity("LRMS_API.AuthorConference", b =>
                {
                    b.HasOne("LRMS_API.Author", "Author")
            ...
            modelBuilder.Entity("LRMS_API.CouncilVote", b =>
                {
                    ...
                    b.HasOne("LRMS_API.GroupMember", "GroupMember")
                        .WithMany("CouncilVotes")
                    ...
                    b.HasOne("LRMS_API.VoteResult", "VoteResult")
                        .WithMany("CouncilVotes")
            ...
            modelBuilder.Entity("LRMS_API.Author", b =>
                {
                    b.Navigation("AuthorConferences");

                    b.Navigation("AuthorJournals");
                });
            ...
            modelBuilder.Entity("LRMS_API.User", b =>
                {
                    b.Navigation("AssignReviewsMade");
